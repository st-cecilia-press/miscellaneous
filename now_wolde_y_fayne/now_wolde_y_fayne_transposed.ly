...
cantusMusic =  \transpose d' a' \relative c' {  
...
tenorMusic = \transpose d a \relative c {
  d2 f4 e  d a' a b  c1\fermata 
  r4 d4 d d  c a bf^\markup{\fontsize #-3 \natural} g f4. \melisma g8 a4 f4  e2 \melismaEnd
